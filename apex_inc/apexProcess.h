...
#ifndef __APEX_PROCESS_H
#define __APEX_PROCESS_H
...
typedef APEX_INTEGER     PRIORITY_TYPE;      /* priority type      */
...
extern void UNLOCK_PREEMPTION (LOCK_LEVEL_TYPE * LOCK_LEVEL,
			       RETURN_CODE_TYPE * RETURN_CODE);
extern void apexTimeMonitorProcGet (PROCESS_ID_TYPE PROCESS_ID,
