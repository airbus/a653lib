...
#ifndef __APEX_SAMPLING_H
#define __APEX_SAMPLING_H
...
typedef APEX_INTEGER SAMPLING_PORT_ID_TYPE; /* sampling port ident type */ 
...
//int apex_init_sampling_ports(int max_port_num, int max_port_size, apex_sampling_port_config_t *config);
