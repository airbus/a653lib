...
#ifndef __APEX_CONFIG_H
#define __APEX_CONFIG_H
...
#define APEX_PARTITION_CONFIG_DEF { \
  2,   /* core number used*/ \
...
#define APEX_PROCESS_CONFIG_DEF { \
  /*process id                              */ \
  /*|      name                             */ \
    {PRCS_A, 0,"Process A                      " },\
    {PRCS_B, 1,"Process B                      " },	\
...
/* #include "apex_pseudo_ports.h" */




/* #define APEX_PSEUDO_SAMPLING_PORT_CONFIG_DEF { \ */
/*     { 2000 , D_AV_MILBUS, {{{ D_MODE_TX, 7, 1, 8, 0 }}} },		\ */
/*     { 0, 0,               {{{         0, 0, 0, 0, 0 }}} }		\ */
/* }  */

/* #define APEX_PSEUDO_QUEUING_PORT_CONFIG_DEF { \ */
/*     { 2000, D_AV_MILBUS,  {{{ D_MODE_TX, 0, 0, 32, 0 }}} },	\ */
/*     { 0, 0,               {{{         0, 0, 0, 0, 0 }}} }	\ */
/* } */

#endif /* __APEX_CONFIG_H */
