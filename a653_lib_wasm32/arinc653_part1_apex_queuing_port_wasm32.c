...
WASM32_HOST_FUNCTION(CREATE_QUEUING_PORT, wasm_baseaddr,
{
...
WASM32_HOST_FUNCTION(SEND_QUEUING_MESSAGE, wasm_baseaddr,
{
  QUEUING_PORT_ID_TYPE QUEUING_PORT_ID;
...
WASM32_HOST_FUNCTION(RECEIVE_QUEUING_MESSAGE, wasm_baseaddr,
{
  QUEUING_PORT_ID_TYPE QUEUING_PORT_ID;
  QUEUING_PORT_ID = (QUEUING_PORT_ID_TYPE)le32toh(GET_ARG_i32(0));
  SYSTEM_TIME_TYPE TIME_OUT;
...
WASM32_HOST_FUNCTION(GET_QUEUING_PORT_ID, wasm_baseaddr,
{
  QUEUING_PORT_ID_TYPE QUEUING_PORT_ID;
  RETURN_CODE_TYPE RETURN_CODE;
...
WASM32_HOST_FUNCTION(GET_QUEUING_PORT_STATUS, wasm_baseaddr,
{
  QUEUING_PORT_ID_TYPE QUEUING_PORT_ID;
  QUEUING_PORT_ID = (QUEUING_PORT_ID_TYPE)le32toh(GET_ARG_i32(0));
...
WASM32_HOST_FUNCTION(CLEAR_QUEUING_PORT, wasm_baseaddr,
{
  QUEUING_PORT_ID_TYPE QUEUING_PORT_ID;
  QUEUING_PORT_ID = (QUEUING_PORT_ID_TYPE)le32toh(GET_ARG_i32(0));
  RETURN_CODE_TYPE RETURN_CODE;
