...
WASM32_HOST_FUNC_HEADER(CREATE_EVENT);
WASM32_HOST_FUNC_HEADER(SET_EVENT);
WASM32_HOST_FUNC_HEADER(RESET_EVENT);
WASM32_HOST_FUNC_HEADER(WAIT_EVENT);
WASM32_HOST_FUNC_HEADER(GET_EVENT_ID);
WASM32_HOST_FUNC_HEADER(GET_EVENT_STATUS);
