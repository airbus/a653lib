...
WASM32_HOST_FUNC_HEADER(REPORT_APPLICATION_MESSAGE);
WASM32_HOST_FUNC_HEADER(CREATE_ERROR_HANDLER);
WASM32_HOST_FUNC_HEADER(GET_ERROR_STATUS);
WASM32_HOST_FUNC_HEADER(RAISE_APPLICATION_ERROR);
WASM32_HOST_FUNC_HEADER(CONFIGURE_ERROR_HANDLER);
