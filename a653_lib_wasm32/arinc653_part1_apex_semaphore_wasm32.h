...
WASM32_HOST_FUNC_HEADER(CREATE_SEMAPHORE);
WASM32_HOST_FUNC_HEADER(WAIT_SEMAPHORE);
WASM32_HOST_FUNC_HEADER(SIGNAL_SEMAPHORE);
WASM32_HOST_FUNC_HEADER(GET_SEMAPHORE_ID);
WASM32_HOST_FUNC_HEADER(GET_SEMAPHORE_STATUS);
