...
WASM32_HOST_FUNC_HEADER__iiiiii(CREATE_SEMAPHORE);
WASM32_HOST_FUNC_HEADER__iIi(WAIT_SEMAPHORE);
WASM32_HOST_FUNC_HEADER__ii(SIGNAL_SEMAPHORE);
WASM32_HOST_FUNC_HEADER__iii(GET_SEMAPHORE_ID);
WASM32_HOST_FUNC_HEADER__iii(GET_SEMAPHORE_STATUS);
