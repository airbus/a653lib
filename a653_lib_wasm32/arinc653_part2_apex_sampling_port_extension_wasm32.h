...
WASM32_HOST_FUNC_HEADER(READ_UPDATED_SAMPLING_MESSAGE);
WASM32_HOST_FUNC_HEADER(GET_SAMPLING_PORT_CURRENT_STATUS);
WASM32_HOST_FUNC_HEADER(READ_SAMPLING_MESSAGE_CONDITIONAL);
