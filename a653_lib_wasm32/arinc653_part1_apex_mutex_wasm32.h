...
WASM32_HOST_FUNC_HEADER__iiiii(CREATE_MUTEX);
WASM32_HOST_FUNC_HEADER__iIi(ACQUIRE_MUTEX);
WASM32_HOST_FUNC_HEADER__ii(RELEASE_MUTEX);
WASM32_HOST_FUNC_HEADER__iii(RESET_MUTEX);
WASM32_HOST_FUNC_HEADER__iii(GET_MUTEX_ID);
WASM32_HOST_FUNC_HEADER__iii(GET_MUTEX_STATUS);
WASM32_HOST_FUNC_HEADER__iii(GET_PROCESS_MUTEX_STATE);
