...
WASM32_HOST_FUNCTION__iiii(CREATE_BLACKBOARD, wasm_baseaddr,
{
...
WASM32_HOST_FUNCTION__iiii(DISPLAY_BLACKBOARD, wasm_baseaddr,
{
  BLACKBOARD_ID_TYPE BLACKBOARD_ID;
...
WASM32_HOST_FUNCTION__iIiii(READ_BLACKBOARD, wasm_baseaddr,
{
  BLACKBOARD_ID_TYPE BLACKBOARD_ID;
  BLACKBOARD_ID = (BLACKBOARD_ID_TYPE)le32toh(GET_ARG_i32(0));
...
WASM32_HOST_FUNCTION__ii(CLEAR_BLACKBOARD, wasm_baseaddr,
{
  BLACKBOARD_ID_TYPE BLACKBOARD_ID;
  BLACKBOARD_ID = (BLACKBOARD_ID_TYPE)le32toh(GET_ARG_i32(0));
...
WASM32_HOST_FUNCTION__iii(GET_BLACKBOARD_ID, wasm_baseaddr,
{
  int32_t BLACKBOARD_NAME; /* is a pointer / address into Wasm linear memory */
  BLACKBOARD_NAME = (int32_t)le32toh(GET_ARG_i32(0));
...
WASM32_HOST_FUNCTION__iii(GET_BLACKBOARD_STATUS, wasm_baseaddr,
{
  BLACKBOARD_ID_TYPE BLACKBOARD_ID;
  BLACKBOARD_ID = (BLACKBOARD_ID_TYPE)le32toh(GET_ARG_i32(0));
