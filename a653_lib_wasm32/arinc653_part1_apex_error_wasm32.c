...
WASM32_HOST_FUNCTION(REPORT_APPLICATION_MESSAGE, wasm_baseaddr,
{
 ...
 */
WASM32_HOST_FUNCTION(CREATE_ERROR_HANDLER, wasm_baseaddr,
{
  ...
  CREATE_ERROR_HANDLER(
    (void*)(uintptr_t)error_handler_trampoline,
    STACK_SIZE,
    &RETURN_CODE
  );
...
WASM32_HOST_FUNCTION(GET_ERROR_STATUS, wasm_baseaddr,
{
...
WASM32_HOST_FUNCTION(RAISE_APPLICATION_ERROR, wasm_baseaddr,
{
...
WASM32_HOST_FUNCTION(CONFIGURE_ERROR_HANDLER, wasm_baseaddr,
{
