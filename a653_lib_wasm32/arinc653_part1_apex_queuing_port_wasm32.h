...
WASM32_HOST_FUNC_HEADER(CREATE_QUEUING_PORT);
WASM32_HOST_FUNC_HEADER(SEND_QUEUING_MESSAGE);
WASM32_HOST_FUNC_HEADER(RECEIVE_QUEUING_MESSAGE);
WASM32_HOST_FUNC_HEADER(GET_QUEUING_PORT_ID);
WASM32_HOST_FUNC_HEADER(GET_QUEUING_PORT_STATUS);
WASM32_HOST_FUNC_HEADER(CLEAR_QUEUING_PORT);
