...
WASM32_HOST_FUNCTION(CREATE_SEMAPHORE, wasm_baseaddr,
{
...
WASM32_HOST_FUNCTION(WAIT_SEMAPHORE, wasm_baseaddr,
{
  SEMAPHORE_ID_TYPE SEMAPHORE_ID;
...
WASM32_HOST_FUNCTION(SIGNAL_SEMAPHORE, wasm_baseaddr,
{
  SEMAPHORE_ID_TYPE SEMAPHORE_ID;
  SEMAPHORE_ID = (SEMAPHORE_ID_TYPE)le32toh(GET_ARG_i32(0));
  RETURN_CODE_TYPE RETURN_CODE;
...
WASM32_HOST_FUNCTION(GET_SEMAPHORE_ID, wasm_baseaddr,
{
  SEMAPHORE_ID_TYPE SEMAPHORE_ID;
  RETURN_CODE_TYPE RETURN_CODE;
...
WASM32_HOST_FUNCTION(GET_SEMAPHORE_STATUS, wasm_baseaddr,
{
  SEMAPHORE_ID_TYPE SEMAPHORE_ID;
  SEMAPHORE_ID = (SEMAPHORE_ID_TYPE)le32toh(GET_ARG_i32(0));
