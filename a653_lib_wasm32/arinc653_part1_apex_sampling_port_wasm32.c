...
WASM32_HOST_FUNCTION(CREATE_SAMPLING_PORT, wasm_baseaddr,
{
...
WASM32_HOST_FUNCTION(WRITE_SAMPLING_MESSAGE, wasm_baseaddr,
{
  SAMPLING_PORT_ID_TYPE SAMPLING_PORT_ID;
...
WASM32_HOST_FUNCTION(READ_SAMPLING_MESSAGE, wasm_baseaddr,
{
  SAMPLING_PORT_ID_TYPE SAMPLING_PORT_ID;
  SAMPLING_PORT_ID = (SAMPLING_PORT_ID_TYPE)le32toh(GET_ARG_i32(0));
  int32_t MESSAGE_ADDR; /* is a pointer / address into Wasm linear memory */
...
WASM32_HOST_FUNCTION(GET_SAMPLING_PORT_ID, wasm_baseaddr,
{
  SAMPLING_PORT_ID_TYPE SAMPLING_PORT_ID;
  RETURN_CODE_TYPE RETURN_CODE;
...
WASM32_HOST_FUNCTION(GET_SAMPLING_PORT_STATUS, wasm_baseaddr,
{
  SAMPLING_PORT_ID_TYPE SAMPLING_PORT_ID;
  SAMPLING_PORT_ID = (SAMPLING_PORT_ID_TYPE)le32toh(GET_ARG_i32(0));
