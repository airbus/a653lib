...
WASM32_HOST_FUNCTION(GET_PROCESS_STATUS, wasm_baseaddr,
{
  ...
  camw32_write__PROCESS_ATTRIBUTE_TYPE__NAME(ATTRIBUTES_guest, (int8_t*)PROCESS_STATUS.ATTRIBUTES.NAME);
})
...
WASM32_HOST_FUNCTION(CREATE_PROCESS, wasm_baseaddr,
{
  ...
  ATTRIBUTES.ENTRY_POINT = (typeof(ATTRIBUTES.ENTRY_POINT))(uintptr_t)&wasm_trampoline;
  assert(sizeof(ATTRIBUTES.ENTRY_POINT) == sizeof(&wasm_trampoline));
  ...
  camw32_read__PROCESS_ATTRIBUTE_TYPE__NAME(ATTRIBUTES__guest, (int8_t*)ATTRIBUTES.NAME);
