...
WASM32_HOST_FUNC_HEADER__iii(GET_PROCESS_ID);
WASM32_HOST_FUNC_HEADER__iii(GET_PROCESS_STATUS);
WASM32_HOST_FUNC_HEADER__iii(CREATE_PROCESS);
WASM32_HOST_FUNC_HEADER__iii(SET_PRIORITY);
WASM32_HOST_FUNC_HEADER__Ii(SUSPEND_SELF);
WASM32_HOST_FUNC_HEADER__ii(SUSPEND);
WASM32_HOST_FUNC_HEADER__ii(RESUME);
WASM32_HOST_FUNC_HEADER(STOP_SELF);
WASM32_HOST_FUNC_HEADER__ii(STOP);
WASM32_HOST_FUNC_HEADER__ii(START);
WASM32_HOST_FUNC_HEADER__iIi(DELAYED_START);
WASM32_HOST_FUNC_HEADER__ii(LOCK_PREEMPTION);
WASM32_HOST_FUNC_HEADER__ii(UNLOCK_PREEMPTION);
WASM32_HOST_FUNC_HEADER__ii(GET_MY_ID);
WASM32_HOST_FUNC_HEADER__iii(INITIALIZE_PROCESS_CORE_AFFINITY);
WASM32_HOST_FUNC_HEADER__ii(GET_MY_PROCESSOR_CORE_ID);
WASM32_HOST_FUNC_HEADER__ii(GET_MY_INDEX);
