...
WASM32_HOST_FUNCTION(TIMED_WAIT, wasm_baseaddr,
{
...
WASM32_HOST_FUNCTION(PERIODIC_WAIT, wasm_baseaddr,
{
  RETURN_CODE_TYPE RETURN_CODE;
...
WASM32_HOST_FUNCTION(GET_TIME, wasm_baseaddr,
{
...
WASM32_HOST_FUNCTION(REPLENISH, wasm_baseaddr,
{
