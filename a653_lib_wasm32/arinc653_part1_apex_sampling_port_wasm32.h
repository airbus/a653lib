...
WASM32_HOST_FUNC_HEADER__iiiIii(CREATE_SAMPLING_PORT);
WASM32_HOST_FUNC_HEADER__iiii(WRITE_SAMPLING_MESSAGE);
WASM32_HOST_FUNC_HEADER__iiiii(READ_SAMPLING_MESSAGE);
WASM32_HOST_FUNC_HEADER__iii(GET_SAMPLING_PORT_ID);
WASM32_HOST_FUNC_HEADER__iii(GET_SAMPLING_PORT_STATUS);
