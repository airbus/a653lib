...
WASM32_HOST_FUNC_HEADER(CREATE_BUFFER);
WASM32_HOST_FUNC_HEADER(SEND_BUFFER);
WASM32_HOST_FUNC_HEADER(RECEIVE_BUFFER);
WASM32_HOST_FUNC_HEADER(GET_BUFFER_ID);
WASM32_HOST_FUNC_HEADER(GET_BUFFER_STATUS);
